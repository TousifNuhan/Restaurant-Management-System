    ...
    return (
        <section>
            ...
            <Swiper
                ...
                autoplay={true}
                modules={[Pagination]}
                className="mySwiper w-4/5 mx-auto mb-10"
            >
                <SwiperSlide>
                    <img src={slide1} alt="" />
                ...
                <SwiperSlide>
                    <img src={slide4} alt="" />
                    <h3 className='text-4xl uppercase -mt-20 text-center text-white'>Deserts</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide5} alt="" />
                    <h3 className='text-4xl uppercase -mt-16 text-center text-white'>Vegetables</h3>
                </SwiperSlide>
